...
namespace TriLibCore.Samples
{
    ...
    public class AssetViewer : AssetViewerBase
    {
        ...
        public void LoadModelByURL(string url)
        {
        ...
        public override void DeleteRootGameObject(bool hasFile)
        {
            base.DeleteRootGameObject(hasFile);
            Debug.Log("Delete Root active");
        }
    }
