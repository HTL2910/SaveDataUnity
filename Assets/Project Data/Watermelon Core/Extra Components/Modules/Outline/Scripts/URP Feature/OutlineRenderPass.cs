...
namespace Watermelon.Outline
{
    public class OutlineRenderPass : ScriptableRenderPass
    {
        ...
        private bool IsDepthTextureAvailable => Renderer.cameraDepthTarget != BuiltinRenderTextureType.None;

        private RenderTargetIdentifier DepthTarget => Renderer.cameraDepthTarget;

        private RenderTargetIdentifier ColorTarget => Renderer.cameraColorTarget;
